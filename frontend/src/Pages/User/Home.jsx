...
import bromoImage from "../../assets/img/bromo.jpg";
import labuanBajoImage from "../../assets/img/labuanBajo.jpg";
import lombokImage from "../../assets/img/lombok.jpg";
              ...
              <Link to={`/products/${category.id_category}`} className="text-decoration-none text-dark">
                <Card.Body className="d-flex flex-column align-items-center">
                  ...
                  <div className="category-subname">
                    {category.categoryName} {/* Tambahkan baris ini */}
                  </div>
                </Card.Body>
              </Link>
            </Card>
  ...
  <Row className="diagnosis-box justify-content-center">
    <Col xs={12}>
      <Row className="align-items-center justify-content-between">
        ...
        <Col xs="auto">
          <Button variant="link" className="see-all-button" as={Link} to="https://www.biofarma.co.id/id/artikel-kesehatan">
            Lihat Semua
          </Button>
        </Col>
      </Row>
      <Row
        ...
        style={{
          display: "grid",
          gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", // Makes the grid responsive
